(dom_loaded => {
    ...
    function updateSidebarAttributesVisible() {
        sidebar_button.setAttribute('title', "Sbalit boční lištu");
        sidebar_button.setAttribute('aria-label', "Sbalit boční lištu");
    ...
    function updateSidebarAttributesHidden() {
        sidebar_button.setAttribute('title', "Rozbalit boční lištu");
        sidebar_button.setAttribute('aria-label', "Rozbalit boční lištu");
