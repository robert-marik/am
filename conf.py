...
copyright = '2022, 2023'
exclude_patterns = ['**.ipynb_checkpoints', '.DS_Store', 'Thumbs.db','_build', 'reseni*', 'cviceni/cviceni00.md', 'cviceni/cviceni13.md', 'cviceni/cviceni14.md', 'cviceni/text.md', 'README.md']
