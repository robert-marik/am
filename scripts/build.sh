...
sed -i 's/<p>manimp:\(.*\)|\(.*\)<\/p>/<div class="obtekat"><figure><a href="https:\/\/um.mendelu.cz\/manim\/\1" target=_blank><img src="https:\/\/um.mendelu.cz\/manim\/thumbs\/\1.jpg"><\/a><figcaption>\2 <a href="https:\/\/user.mendelu.cz\/marik\/manim\/\1" class=but-prez target=_blank>Otevřít prezentaci<\/a><\/figcaption><\/figure><\/div>/' $directory/*/index.html
